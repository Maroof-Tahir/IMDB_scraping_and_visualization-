...
def scrape_imdb_top_250():
    url = 'https://www.imdb.com/chart/toptv/?ref_=nv_tvv_250&sort=num_votes%2Cdesc'
...
def insert_into_database(movies):
    ...
    cursor.execute(''' 
    IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='IMDB_Top_250_Shows_num_of_votes' AND xtype='U')
    BEGIN
        CREATE TABLE IMDB_Top_250_Shows_num_of_votes (
    ...
    for movie in movies:
        cursor.execute('''
            INSERT INTO IMDB_Top_250_Shows_num_of_votes 
