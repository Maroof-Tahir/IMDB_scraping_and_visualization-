...
def scrape_imdb_top_250():
    url = 'https://www.imdb.com/chart/top/?ref_=nv_mv_250&sort=release_date%2Cdesc'
...
def insert_into_database(movies):
    ...
    cursor.execute(''' 
    IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='IMDB_Top_250_movies_release_date' AND xtype='U')
    BEGIN
        CREATE TABLE IMDB_Top_250_movies_release_date (
    ...
    for movie in movies:
        cursor.execute('''
            INSERT INTO IMDB_Top_250_movies_release_date 
