...
def insert_into_database(movies):
    ...
    cursor.execute(''' 
    IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='IMDB_Top_250_movies_popularity' AND xtype='U')
    BEGIN
        CREATE TABLE IMDB_Top_250_movies_popularity (
    ...
    for movie in movies:
        cursor.execute('''
            INSERT INTO IMDB_Top_250_movies_popularity 
